// Thème & dimensions du mode kiosque (US-8.5, #159).
//
...
//
// Les valeurs de `KioskDimensions` restent des cibles « gros boutons tactiles » à
...
class KioskDimensions {
  const KioskDimensions._();
  ...
  /// Côté minimal d'une carte de prestation (grille) — photo + libellé + prix
  /// lisibles sans s'approcher de l'écran.
  static const double serviceCardMinSide = 160;
...
/// `ThemeData` du mode kiosque — palette et typographie **fixes** (`KioskColors`),
/// jamais dérivées d'une graine `ColorScheme.fromSeed`.
ThemeData buildKioskTheme() {
  const colorScheme = ColorScheme.light(
    surface: KioskColors.background,
    onSurface: KioskColors.ink,
    primary: KioskColors.accent,
    onPrimary: KioskColors.accentForeground,
    secondary: KioskColors.gold,
    onSecondary: KioskColors.accentForeground,
    error: KioskColors.danger,
    onError: KioskColors.accentForeground,
  ...
  final textTheme = bodyTextTheme
      ...
      .apply(
        bodyColor: KioskColors.ink,
        displayColor: KioskColors.ink,
        fontSizeFactor: 1.15,
      );
  ...
  final buttonTextStyle = GoogleFonts.outfit(
    fontSize: KioskDimensions.bodyFontSize,
    fontWeight: FontWeight.w600,
  );
  const minButtonSize = Size.fromHeight(KioskDimensions.primaryButtonHeight);
  ...
  return ThemeData(
    ...
    filledButtonTheme: FilledButtonThemeData(
      style: FilledButton.styleFrom(
        ...
        foregroundColor: KioskColors.accentForeground,
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        foregroundColor: KioskColors.ink,
        side: const BorderSide(color: KioskColors.border, width: 1.5),
        minimumSize: minButtonSize,
        textStyle: buttonTextStyle,
        shape: buttonShape,
      ),
    ...
    cardTheme: CardThemeData(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: const BorderSide(color: KioskColors.border),
      ),
    ),
    inputDecorationTheme: InputDecorationTheme(
      filled: true,
      fillColor: KioskColors.surface,
      contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 20),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(16),
        borderSide: const BorderSide(color: KioskColors.border, width: 1.5),
      ),
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(16),
        borderSide: const BorderSide(color: KioskColors.accent, width: 2),
      ),
    ),
    dividerColor: KioskColors.border,
    dividerTheme: const DividerThemeData(color: KioskColors.border),
