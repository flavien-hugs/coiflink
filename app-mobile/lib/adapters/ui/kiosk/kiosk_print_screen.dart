...
class KioskPrintScreen extends StatefulWidget {
  const KioskPrintScreen({
    super.key,
    required this.deps,
  ...
  /// `KioskInactivityGuard` hérité (`maybeOf`).
  final KioskInactivityController? controllerOverride;

  @override
  State<KioskPrintScreen> createState() => _KioskPrintScreenState();
}

class _KioskPrintScreenState extends State<KioskPrintScreen> {
  KioskInactivityController? _controller;
  ...
  void didChangeDependencies() {
    ...
    _controller =
        widget.controllerOverride ?? KioskInactivityGuard.maybeOf(context);
    if (!_printStarted) {
      _printStarted = true;
