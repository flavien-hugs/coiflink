...
//
// Les routes réservées au rôle TERMINAL (#156, #157) partagent la **même** politique :
...
Future<http.Response> postWithTerminalReauth({
  required http.Client client,
  required TerminalDeviceSession session,
  required Uri uri,
