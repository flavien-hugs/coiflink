// Tests widget — KioskPrintScreen (US-007, #159 · consomme #160).
//
...
class _FakeController implements KioskInactivityController {
...
KioskDeps _makeDeps(TicketPrinterGateway printer) => KioskDeps(
      salonId: 'salon-1',
...
Widget _buildScreen({
  ...
  KioskInactivityController? controller,
...
void main() {
  group('KioskPrintScreen — affichage', () {
  ...
  group('KioskPrintScreen — séquence d\'impression', () {
  ...
  group('KioskPrintScreen — gestion des erreurs d\'impression', () {
  ...
  group('KioskPrintScreen — navigation', () {
