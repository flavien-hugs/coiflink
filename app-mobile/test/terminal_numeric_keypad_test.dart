// Tests widget — TerminalNumericKeypad (US-8.5, #159).
//
...
//
// `TerminalNumericKeypad` est un widget **contrôlé** (stateless) : le parent tient
// la chaîne saisie. Les tests pilotent les callbacks directement.

import 'package:flutter/material.dart';
import 'package:flutter_test/flutter_test.dart';

import 'package:coiflink_mobile/adapters/ui/terminal/terminal_numeric_keypad.dart';
...
void main() {
  group('TerminalNumericKeypad — touches chiffres', () {
  ...
  group('TerminalNumericKeypad — touche correction', () {
  ...
  group('TerminalNumericKeypad — touche validation', () {
  ...
  group('TerminalNumericKeypad — interactions enchaînées', () {
