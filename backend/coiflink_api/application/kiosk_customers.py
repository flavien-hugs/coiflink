"""Cas d'usage : **identité walk-in depuis la borne kiosque** (US-8.2, #156).
...
class IdentifyWalkInCustomer:
    ...
    (réutilise le port `LoginRateLimiter`, comme le login kiosque #155). Ne comptent
    ...
    **minimale** (`WalkInIdentity`), jamais la fiche complète.
    ...
    def execute(
        ...
        *,
        ...
        (une ligne `users` `role=KIOSK`, ADR-0041) : il satisfait la FK NOT NULL
