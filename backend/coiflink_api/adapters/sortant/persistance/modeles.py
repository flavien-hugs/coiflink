...
d'infrastructure et ne sont jamais importées par `domaine/` ni `application/`.
...
- **Énumérations** stockées en `text` + contrainte `CHECK` *dérivée du domaine*
  (`coiflink_api.domaine.enums`) — évolutif sans `ALTER TYPE`.
...
from coiflink_api.domaine import enums
