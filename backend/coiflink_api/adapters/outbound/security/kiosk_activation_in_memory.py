...
Implémentation du port `KioskActivationRepository` suffisante pour les tests et le
...
Une **instance dédiée** est câblée sur `app.state.kiosk_activation_repository`,
...
class InMemoryKioskActivationRepository:
...
__all__ = ["InMemoryKioskActivationRepository"]
