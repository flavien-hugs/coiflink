...
// US-5.2 #35). Charge **côté serveur** (jeton du cookie httpOnly, jamais exposé
// au navigateur, invariant #14) le salon du gérant et l'**historique filtrable**
// de ses transactions :
//   - aucun salon → invite à créer d'abord le salon (Paramètres, #15) ;
//   - un salon    → vue « Historique des transactions ».
// L'encaissement lui-même se fait désormais depuis le ticket (file d'attente,
// #157) — plus de formulaire autonome sur cette page. L'historique (#35) reste
// **filtrable côté serveur** (date, mode, recherche libre `q` via `searchParams`)
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-muted">
        Retrouvez vos transactions dans l&apos;historique filtrable — cohérent
