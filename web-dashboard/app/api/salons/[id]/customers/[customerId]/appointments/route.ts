// Route Handler BFF `GET /api/salons/[id]/customers/[customerId]/appointments`
// (historique des visites terminées d'une fiche, US-4.2 #29) — composition root.
// Lit le jeton d'accès du cookie httpOnly **côté serveur** (jamais exposé au
// navigateur, invariant #14), proxifie l'appel au backend via `CustomerGateway`,
// puis renvoie un corps sans secret.
//
